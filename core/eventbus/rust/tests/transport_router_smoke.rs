use cat_eventbus::{
    EndpointTransport, EventEnvelope, EventKind, EventRouter, RecordingTransport,
    TransportEndpoint, TransportId, TransportRegistry, TransportRoute,
};
use uuid::Uuid;
