...
pub struct ContentVersionCreated { pub content_id: ContentId, pub version: u32 }
...
#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct ContentPublished { pub content_id: ContentId, pub version: u32, pub publication_id: Uuid }
