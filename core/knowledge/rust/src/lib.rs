...
pub use persistence::{
    KnowledgePersistenceError, KnowledgePersistenceResult, KnowledgeSnapshotStore,
    MemorySnapshotStore,
};
...
pub use validation::{KnowledgeViolation, validate_edge, validate_evidence, validate_node};
